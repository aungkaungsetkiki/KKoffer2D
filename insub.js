...
const messages = [
    ...
    { text: "2Dစာရင်းအင်းများကို", duration: 2000, type: "medium" },
    ...
    { text: "ယခု Webappအား အသုံးပြုရန်", duration: 2000, type: "medium" },
    { text: "သုံးသိန်းငါးသောင်း ကျပ် (၃၅၀၀၀၀ကျပ်)တိတိ ကျသင့်ပါမည်", duration: 5000, type: "long" },
    { text: "Server ကြေးပေးသွင်းရန်မှာ", duration: 2000, type: "medium" },
    { text: "အလုပ်ပေါ်မူတည်ပါတယ် Data မများပါက မလိုအပ်နိုင်", duration: 2000, type: "long" },
